      ...
      <div class='collapse navbar-collapse' id='navbarText'>
        ...
        <ul class='navbar-nav'>
          <li class='nav-item' style='float: right;'>
            <a class='nav-link' href='perfil.php'><img style='width: 30px; height:30px' class='rounded-circle' src='"; echo $_SESSION['foto']; echo"' alt='user'></a>
          </li>
          <li class='nav-item dropdown active' style='float: right'>
            ...
            <div class='dropdown-menu' aria-labelledby='navbarDropdownMenuLink' style='left: -130%;'>
              <a class='dropdown-item' href='perfil.php'>Editar mi perfil</a>
